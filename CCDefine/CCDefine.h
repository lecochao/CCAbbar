...
// token
#define k_SET_TOKEN(tokenStr)  k_SET_OBJECT(tokenStr,@"CCAbbar.token");
#define k_GET_TOKEN  k_GET_OBJECT(@"CCAbbar.token");
#define k_REMOVE_TOKEN  [[NSUserDefaults standardUserDefaults]removeObjectForKey:@"CCAbbar.token"];
